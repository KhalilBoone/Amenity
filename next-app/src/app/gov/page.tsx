...
export default function GovPage() {
  ...
  return (
    <>
      {/* ── CREDENTIALS BAR ─────────────────────────────────────────────── */}
      <div className="fixed top-0 left-0 right-0 z-[110] bg-white border-b border-black/[0.07] hidden md:flex justify-center items-center h-9 overflow-hidden flex-wrap" style={{ paddingLeft: 48, paddingRight: 48 }}>
        {[
          { label: "UEI",          value: "[YOUR UEI]" },
          { label: "CAGE",         value: "[CAGE CODE]" },
          { label: "Primary NAICS",value: "315210" },
        ].map(({ label, value }) => (
          <div key={label} className="flex items-center gap-[7px] px-5 h-full border-r border-black/[0.08]">
            <span className="text-[10px] font-semibold tracking-[1.2px] uppercase text-black/40">{label}</span>
            <span className="text-[11px] font-bold text-black tracking-[.3px]">{value}</span>
          </div>
        ))}
        <div className="flex items-center gap-[7px] px-5 h-full">
          <div className="flex items-center gap-1.5 text-[10px] font-extrabold tracking-[1.5px] uppercase text-[#16a34a]">
      ...
      {/* ── HERO ────────────────────────────────────────────────────────── */}
      <div className="relative bg-[#0b1628] min-h-screen flex flex-col justify-end px-5 md:px-[60px] pt-[76px] md:pt-0 pb-16 md:pb-20 overflow-x-hidden">
        {/* Blueprint grid */}
        ...
        <div className="max-w-[1200px] mx-auto w-full relative z-10">
          <div className="inline-flex items-center gap-2.5 text-[10px] font-extrabold tracking-[2.5px] uppercase text-[#2b7fff] mb-7 pt-16 md:pt-40">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          {SUPPLY_CATALOG.map((c) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-[rgba(0,0,0,.52)] group-hover:bg-[rgba(0,0,0,.65)] transition-all flex flex-col justify-end p-3 md:p-[22px]">
                <div className="text-[8px] md:text-[9px] font-extrabold tracking-[2.5px] uppercase text-white/55 mb-[7px] text-left">{c.psc}</div>
