    ...
    <div className="min-h-screen bg-[#0f0f0f] flex">
      ...
      <aside className="w-[240px] flex-shrink-0 bg-[#0a0a0a] border-r border-white/[0.07] flex flex-col">
        ...
        <nav className="flex-1 p-3 flex flex-col gap-1 pt-4">
          ...
          <Link href="/#order" className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-white/45 hover:text-white hover:bg-white/[0.05] text-[13px] no-underline transition-colors">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
